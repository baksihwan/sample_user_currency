...
import com.sparta.currency_user.dto.ExchangeSaveRequestDto;
import com.sparta.currency_user.dto.ExchangeUpdateRequestDto;
...
public class ExchangeController {
    ...
    // 환전 요청 등록
    @PostMapping
    public ResponseEntity<ExchangeResponseDto> createExchange(@RequestBody ExchangeSaveRequestDto exchangeSaveRequestDto) {
